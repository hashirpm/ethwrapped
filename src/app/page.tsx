  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <button
          onClick={async() => {
            await fetchDetailsOfYear("0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045"); //Vitalik.eth
            ...
            await getTokenBalances("0xA4DA350702f06FB8AdE5eba73cdF63DCbBd3a426"); //Taking time
