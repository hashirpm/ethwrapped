                ...
                data == null ?
                    ...
                    <div className="flex justify-center flex-col gap-10 items-center xl:h-[calc(100vh-150px)] pt-[100px]">
                        ...
                        <div className="flex gap-4 dark">
                            ...
                            <Link href={`https://twitter.com/intent/tweet?text=${data.txnCount}%20transactions%20in%202023🤯wanna%20get%20yours?%20checkout%20https://ethwrapped.xyz%20built%20by%20@0xShiyasmohd%20and%20@0xHashir`} target="_blank">
                                <button
